...
namespace vkUtils {
	/*
		Find the index of memory type on the GPU satisfying the given properties
	...
	*/
	...
	uint32_t findMemoryTypeIndex(
		vk::PhysicalDevice physicalDevice, uint32_t supportedMemoryIndices, vk::MemoryPropertyFlags requestedProperties
	);
